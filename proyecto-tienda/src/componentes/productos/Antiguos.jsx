    ...
    <section className="antiguos" id="antiguos">
      <article>
        ...
        <div className='antiguos_list'>
          <a href="#" className="antiguos fort"><img src={Fort} alt="Fort" className="antiguos fort" /></a>
          <a href="#" className="antiguos mva"><img src={MVA} alt="MVA" className="antiguos mva" /></a>
          <a href="" className="antiguos plymout"><img src={Plymout} alt="Plymout" className="antiguos pymout" /></a>
          <a href="" className="antiguos taury"><img src={Taury} alt="Taury" className="antiguos taury" /></a>
        </div>
